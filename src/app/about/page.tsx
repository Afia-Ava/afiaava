...
export default function About() {
  ...
  <main className="flex flex-col items-center justify-center px-4 md:px-0 pt-24 flex-1">
        ...
        <div className="max-w-2xl mx-auto text-[#ededed] text-base md:text-lg leading-relaxed text-left" style={{ fontFamily: 'Inter, var(--font-geist-sans), Arial, sans-serif', fontWeight: 400, letterSpacing: '-0.02em', lineHeight: '1.7' }}>
          <p className="mb-3">hi! im glad you're here. nice to meet you :)</p>
          <p className="mb-3">i'm just a girl who loves creating stuff for others. most of what i make starts small from a note, sketch, or half-finished prototype at 1 a.m. i really love the process of shaping something messy to something that makes sense. and most importantly, making friends along the way!</p>
          <p className="mb-3">i’ve moved around a lot and been to seven schools. adaptability and curiosity have kind of become my second nature. over the past few years, i’ve worked on projects that live between sustainability, education, and tech. i've had the opportunity to work with some incredible people, and meeting them has been the best part so far. </p>
          <p className="mb-3">outside of building, i'm a little lazy. so i wont be doing the most athletic things. but i dont mind waking up early to see the sunrise, taking a walk on a nice-weather day, sit by the beach and mountains for hours, do my amateur photography, or hiking sort of stuff if im really feeling it... mostly, i love quiet and calm things. </p>
          <p className="mb-3">right now, i'm so into the intersection of tech + human. i want to design tools that are functional, thoughtful, and emotionally aware. i’m always drawn to work that helps people’s lives in a positive way.</p>
          <p className="mb-3">i don't know exactly where all this will lead, but i'm excited to enjoy the journey and keep learning. i hope to live as a creative technologist. </p>
          <p className="mb-3">thanks for reading this far. i'm always down to connecting with new people and sharing ideas. you can ping me at afiakhanomava@gmail.com or find me on socials. </p>
          <p className="mb-3">have a great day ahead. </p>
        </div>
  <div className="h-32" />
      </main>
